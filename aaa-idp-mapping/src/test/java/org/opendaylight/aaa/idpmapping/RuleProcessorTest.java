...
public class RuleProcessorTest {
    ...
    public void testProcess() throws Exception {
        ...
        Map<String, Object> internalRule = new HashMap<String, Object>() {{
            put("Name", "Admin");put("statement_blocks","user");
        }};
        internalRules.add(internalRule);
        MemberModifier.field(RuleProcessor.class,"rules").set(ruleProcess, internalRules);
        PowerMockito.suppress(MemberMatcher.method(RuleProcessor.class, "processRule", Map.class, Map.class));
        PowerMockito.when(ruleProcess, "processRule", any(Map.class), any(Map.class)).thenReturn(ProcessResult.RULE_SUCCESS);
        PowerMockito.suppress(MemberMatcher.method(RuleProcessor.class, "getMapping", Map.class, Map.class));
