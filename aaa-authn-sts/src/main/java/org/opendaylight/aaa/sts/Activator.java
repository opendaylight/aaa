...
public class Activator extends DependencyActivatorBase {
    ...
    public void init(BundleContext context, DependencyManager manager)
        ...
        final ServiceTracker<AuthenticationService, AuthenticationService> authenticationService = new ServiceTracker<>(context, AuthenticationService.class,
        ...
        final ServiceTracker<IdMService, IdMService> idmService = new ServiceTracker<>(context, IdMService.class,
        ...
        final ServiceTracker<TokenAuth, TokenAuth> tokenAuthService = new ServiceTracker<>(context, TokenAuth.class,
        ...
        final ServiceTracker<TokenStore, TokenStore> tokenStoreService = new ServiceTracker<>(context, TokenStore.class,
        ...
        final ServiceTracker<ClientService, ClientService> clientService = new ServiceTracker<>(context, ClientService.class,
