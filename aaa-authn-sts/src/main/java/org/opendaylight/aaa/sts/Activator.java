...
public class Activator extends DependencyActivatorBase {
    ...
    public void init(BundleContext context, DependencyManager manager)
        ...
        authenticationService = new ServiceTracker<>(context, AuthenticationService.class,
                new AAAServiceTrackerCustomizer<AuthenticationService>(new Callable() {
                    @Override
                    public Object call() {
        ...
        idmService = new ServiceTracker<>(context, IdMService.class,
                new AAAServiceTrackerCustomizer<IdMService>(new Callable() {
                    @Override
        ...
        tokenAuthService = new ServiceTracker<>(context, TokenAuth.class,
                new AAAServiceTrackerCustomizer<TokenAuth>(new Callable() {
                    @Override
                    public Object call() throws Exception {
        ...
        tokenStoreService = new ServiceTracker<>(context, TokenStore.class,
                new AAAServiceTrackerCustomizer<TokenStore>(new Callable() {
                    @Override
                    public Object call() throws Exception {
        ...
        clientService = new ServiceTracker<>(context, ClientService.class,
                new AAAServiceTrackerCustomizer<ClientService>(new Callable() {
                    @Override
                    public Object call() throws Exception {
