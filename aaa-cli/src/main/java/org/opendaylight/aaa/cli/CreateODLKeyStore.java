...
import org.opendaylight.aaa.cert.api.IaaaCertificateProvider;
...
public class CreateODLKeyStore extends OsgiCommandSupport{
    ...
    protected IaaaCertificateProvider certProvider;
    ...
    public CreateODLKeyStore(IaaaCertificateProvider aaaCertProvider) {
