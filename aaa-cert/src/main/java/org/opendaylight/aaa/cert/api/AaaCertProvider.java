...
import org.opendaylight.yang.gen.v1.urn.opendaylight.yang.aaa.cert.rpc.rev151215.SetNodeCertificateReqInput;
...
public class AaaCertProvider implements AutoCloseable, IAaaCertProvider, BindingAwareProvider, AaaCertRpcService {
    ...
    @Override
    public Future<RpcResult<Void>> setNodeCertificateReq(SetNodeCertificateReqInput input) {
