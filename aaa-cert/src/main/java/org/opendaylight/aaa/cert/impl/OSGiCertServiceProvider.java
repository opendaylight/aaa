...
public final class OSGiCertServiceProvider extends ForwardingObject implements ICertificateManager {
    ...
    @Reference
    void setCertificateManagerService(final AaaCertServiceConfig certServiceConfig) {
        LOG.info("Initializing OSGiCertServiceProvider...");
        certService = new CertificateManagerService(certServiceConfig, verifyNotNull(dataBroker),
                verifyNotNull(encryptionService));
        LOG.info("CertificateManagerService activated");
    }
