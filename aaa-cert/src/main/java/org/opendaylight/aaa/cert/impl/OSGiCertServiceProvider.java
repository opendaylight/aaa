...
@Component(immediate = true, service = ICertificateManager.class)
public class OSGiCertServiceProvider extends ForwardingObject implements ICertificateManager {
    ...
    CertificateManagerService certService = null;
