...
public interface IAaaCertProvider {
     ...
     */
    @Nonnull String genODLKeyStoreCertificateReq(@Nonnull String storePasswd, @Nonnull String alias, final boolean withTag);
     ...
     * @return the certificate request
     */
    @Nonnull String genODLKeyStoreCertificateReq(@Nonnull String alias, final boolean withTag);
     ...
     */
    @Nonnull String getCertificateTrustStore(@Nonnull String storePasswd, @Nonnull String alias, final boolean withTag);
     ...
     * @return the certificate
     */
    @Nonnull String getODLKeyStoreCertificate(@Nonnull String storePasswd, @Nonnull String alias, final boolean withTag);
     ...
     * @return the certificate
     */
    @Nonnull String getODLKeyStoreCertificate(@Nonnull String alias, final boolean withTag);
