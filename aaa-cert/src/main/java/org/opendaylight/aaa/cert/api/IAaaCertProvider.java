...
public interface IAaaCertProvider extends java.lang.AutoCloseable {
    ...
    String addCertificateTrustStore(String storePasswd, String alias, String certificate);
    ...
    String addCertificateODLKeyStore(String storePasswd, String alias, String certificate);
}
