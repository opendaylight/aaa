...
/**
 * Implement the basic RPC operation that add and retrieve certificates to the keystores.
 * Those RPC are accessible only for the ODL admin role and can be disabled. Check the shiro.ini file for more info.
 *
 * @author mserngawy
 *
 */
