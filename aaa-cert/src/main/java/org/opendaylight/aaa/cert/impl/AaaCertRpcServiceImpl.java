...
public class AaaCertRpcServiceImpl implements AaaCertRpcService {
    ...
    @Override
    public ListenableFuture<RpcResult<GetNodeCertificateOutput>> getNodeCertificate(final GetNodeCertificateInput input) {
        ...
        if (!Strings.isNullOrEmpty(cert)) {
            ...
            futureResult.set(RpcResultBuilder.<GetNodeCertificateOutput>failed().build());
        }
        return futureResult;
    }
    ...
    @Override
    public ListenableFuture<RpcResult<SetNodeCertificateOutput>> setNodeCertificate(final SetNodeCertificateInput input) {
