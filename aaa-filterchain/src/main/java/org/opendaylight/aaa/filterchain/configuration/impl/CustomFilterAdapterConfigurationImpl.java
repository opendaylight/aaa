...
public final class CustomFilterAdapterConfigurationImpl implements CustomFilterAdapterConfiguration {
    ...
    private static volatile CustomFilterAdapterConfigurationImpl INSTANCE;

    public static CustomFilterAdapterConfigurationImpl newInstance(Map<String, String> properties) {
        INSTANCE = new CustomFilterAdapterConfigurationImpl();
        INSTANCE.update(properties);
        return INSTANCE;
    }

    public static CustomFilterAdapterConfigurationImpl getInstance() {
        return INSTANCE;
    }
