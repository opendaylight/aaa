 ...
 * Pattern to allow for programatic injection of Filters.  Essentially, the
...
public final class AAAFilterChain implements FilterChain {
    ...
    private volatile List<Filter> injectedFilterChain;
    ...
    public void doFilter(final ServletRequest request, final ServletResponse response,
        ...
        this.injectedFilterChain = injectedFilterChain;
        this.existingFilterChain = existingFilterChain;
        this.injectedFilterChainIterator = this.injectedFilterChain.iterator();
