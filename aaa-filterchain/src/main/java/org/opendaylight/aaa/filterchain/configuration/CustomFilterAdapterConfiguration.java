 ...
 *
 * <p>Edit <code>etc/org.opendaylight.aaa.filterchain.cfg</code>:
 *
 * <p>Add Filters in the following form:
 * <code>customFilterList = c.b.a.TestFilter1,f.d.e.TestFilter2,j.h.i.FilterN</code>
 *
 * <p>If you wish to specify key/value init-params (normally done in web.xml), you
 ...
 *
 * <p>This class follows the Singleton design pattern, and the instance is
 * extracted through:
 * <code>CustomFilterAdapterConfiguration.getInstance()</code>
 *
 * <p>Users can subscribe for changes via {@link #registerCustomFilterAdapterConfigurationListener}
 */
