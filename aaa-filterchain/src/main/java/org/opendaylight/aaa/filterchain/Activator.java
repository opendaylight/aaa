...
public class Activator extends DependencyActivatorBase {
    ...
    public void init(final BundleContext bc, final DependencyManager dm) throws Exception {
        ...
        dm.add(createComponent().setInterface(new String[] { CustomFilterAdapterConfiguration.class.getName() },
                null).setImplementation(CustomFilterAdapterConfiguration.getInstance()));
        ...
        bc.registerService(ManagedService.class,
