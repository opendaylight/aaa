 ...
 */
public abstract class JpaDependentDao<I extends Serializable, T extends Identifiable<? super T, I> & Dependent<Id<O, E>>, P, F, S, E extends Serializable, O extends Identifiable<? super O, E>, W>
        extends JpaKeyValueDependentDao<I, T, P, E, O, W> implements DependentDao<I, T, F, S, E, O, JpaContext> {
     ...
     */
    protected JpaDependentDao(Class<P> entityClass) {
        super(entityClass);
    }
     ...
     */
    protected JpaDependentDao(Class<P> entityClass, UpdateStrategy<P, T> updateStrategy) {
