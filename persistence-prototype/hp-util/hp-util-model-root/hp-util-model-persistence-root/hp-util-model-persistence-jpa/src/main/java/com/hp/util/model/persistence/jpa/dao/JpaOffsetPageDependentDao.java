...
import com.hp.util.model.persistence.dao.OffsetPageDependentDao;
...
/**
 * JPA {@link OffsetPageDependentDao}.
 * <p>
 ...
 */
public abstract class JpaOffsetPageDependentDao<I extends Serializable, T extends Identifiable<? super T, I> & Dependent<Id<O, E>>, P, F, S, E extends Serializable, O extends Identifiable<? super O, E>, W>
        extends JpaDependentDao<I, T, P, F, S, E, O, W> implements OffsetPageDependentDao<I, T, F, S, E, O, JpaContext> {
     ...
     */
    protected JpaOffsetPageDependentDao(Class<P> entityClass) {
        super(entityClass);
    }
     ...
     */
    protected JpaOffsetPageDependentDao(Class<P> entityClass, UpdateStrategy<P, T> updateStrategy) {
