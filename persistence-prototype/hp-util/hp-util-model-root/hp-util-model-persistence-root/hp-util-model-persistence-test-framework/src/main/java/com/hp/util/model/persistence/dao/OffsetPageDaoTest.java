 ...
 */
public abstract class OffsetPageDaoTest<I extends Serializable, T extends Identifiable<? super T, I>, F, S, C, D extends OffsetPageDao<I, T, F, S, C>>
     ...
     */
    public OffsetPageDaoTest(DataStore<C> dataStore) {
        super(dataStore);
    }
