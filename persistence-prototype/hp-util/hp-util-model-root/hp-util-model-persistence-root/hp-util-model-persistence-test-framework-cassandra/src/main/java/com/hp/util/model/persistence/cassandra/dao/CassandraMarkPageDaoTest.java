...
import com.hp.util.model.persistence.dao.MarkPageDaoTest;

/**
 * Integration test for {@link CassandraMarkPageDao} implementations.
 * 
 ...
 */
public abstract class CassandraMarkPageDaoTest<I extends Serializable, T extends Identifiable<? super T, I>, F, S, D extends MarkPageDao<I, T, F, S, CassandraContext<Astyanax>> & ColumnFamilyHandler>
        extends MarkPageDaoTest<I, T, F, S, CassandraContext<Astyanax>, D> {

    /**
     * Creates a new DAO integration test.
     */
    public CassandraMarkPageDaoTest() {
