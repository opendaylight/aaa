...
import com.hp.util.model.persistence.dao.BaseDaoTest;
 ...
 */
public abstract class CassandraBaseDaoTest<I extends Serializable, T extends Identifiable<? super T, I>, D extends BaseDao<I, T, CassandraContext<Astyanax>> & ColumnFamilyHandler>
        extends BaseDaoTest<I, T, CassandraContext<Astyanax>, D> {

    /**
     * Creates a new DAO integration test.
     */
    public CassandraBaseDaoTest() {
