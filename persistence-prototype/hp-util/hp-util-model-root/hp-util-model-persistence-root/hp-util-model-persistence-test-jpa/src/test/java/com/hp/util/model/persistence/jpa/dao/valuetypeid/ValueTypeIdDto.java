...
public class ValueTypeIdDto extends AbstractIdentifiable<ValueTypeIdDto, MacAddress> {
    ...
    public ValueTypeIdDto(Id<ValueTypeIdDto, MacAddress> id, String attributeString, boolean attributeBoolean,
