...
@Entity
@Table(name = "no_integrity_one_to_many_relation_many_side_entity")
...
public class OneToManyNoIntegrityManyEntity extends BaseEntity {
     ...
     */
    @Deprecated
    public OneToManyNoIntegrityManyEntity() {

    }

    public OneToManyNoIntegrityManyEntity(String attributeString, boolean attributeBoolean, Long attributeLong,
    ...
    public void setRelativeId(Long id) {
        this.relativeId = id;
    }
}
