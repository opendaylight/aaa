...
public class OneDto extends AbstractIdentifiable<OneDto, Long> {
    ...
    public OneDto(String attributeString, boolean attributeBoolean, Long attributeLong, Date attributeDate,
        EnumMock attributeEnum) {
        this(null, attributeString, attributeBoolean, attributeLong, attributeDate, attributeEnum);
    }

    public OneDto(Id<OneDto, Long> id, String attributeString, boolean attributeBoolean, Long attributeLong,
