...
public class CompositeIdDto extends AbstractIdentifiable<CompositeIdDto, CompositeId> {
    ...
    public CompositeIdDto(Id<CompositeIdDto, CompositeId> id, String attributeString, boolean attributeBoolean,
