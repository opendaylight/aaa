...
public class IndependentDto extends AbstractIdentifiable<IndependentDto, Long> implements Versionable {
    ...
    private Collection<DependentDto> dependents = new ArrayList<DependentDto>();

    public IndependentDto(String attributeString, boolean attributeBoolean, Long attributeLong, Date attributeDate,
        EnumMock attributeEnum) {
        this(null, attributeString, attributeBoolean, attributeLong, attributeDate, attributeEnum);
    }

    public IndependentDto(Id<IndependentDto, Long> id, String attributeString, boolean attributeBoolean,
    ...
    public void removeDependent(DependentDto dependent) {
        this.dependents.remove(dependent);
    }

    public Collection<DependentDto> getDependents() {
        return Collections.unmodifiableCollection(new ArrayList<DependentDto>(this.dependents));
    }
}
