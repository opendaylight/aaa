...
public class CustomIdDto extends AbstractIdentifiable<CustomIdDto, String> {
    ...
    public CustomIdDto(Id<CustomIdDto, String> id, String attributeString, boolean attributeBoolean,
