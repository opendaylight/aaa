...
@Entity
@Table(name = "integrity_one_to_many_relation_one_side_entity")
...
public class OneToManyIntegrityOneEntity extends BaseEntity {

    // The relation is unidirectional. In order to retrieve the ManyEntity collection a OneEntity is related to,
    // the ManyDao can be used to find the relatives using a relative filter criteria.
     ...
     */
    @Deprecated
    public OneToManyIntegrityOneEntity() {

    }

    public OneToManyIntegrityOneEntity(String attributeString, boolean attributeBoolean, Long attributeLong,
