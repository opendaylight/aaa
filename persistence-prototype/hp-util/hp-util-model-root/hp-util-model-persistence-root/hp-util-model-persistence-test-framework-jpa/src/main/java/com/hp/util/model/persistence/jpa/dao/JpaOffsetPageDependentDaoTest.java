...
/**
 * Integration test for JPA {@link OffsetPageDependentDao} implementations.
 * 
 ...
 */
public abstract class JpaOffsetPageDependentDaoTest<I extends Serializable, T extends Identifiable<? super T, I> & Dependent<Id<O, E>>, F, S, E extends Serializable, O extends Identifiable<? super O, E>, D extends OffsetPageDependentDao<I, T, F, S, E, O, JpaContext>>
        extends DependentDaoTest<I, T, F, S, E, O, JpaContext, D> {

    /**
     * Creates a JPA DAO test.
     */
    public JpaOffsetPageDependentDaoTest() {
