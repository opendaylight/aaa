...
/**
 * Integration test for JPA {@link OffsetPageDao} implementations.
 * 
 ...
 */
public abstract class JpaOffsetPageDaoTest<I extends Serializable, T extends Identifiable<? super T, I>, F, S, D extends OffsetPageDao<I, T, F, S, JpaContext>>
        extends OffsetPageDaoTest<I, T, F, S, JpaContext, D> {

    /**
     * Creates a JPA DAO test.
     */
    public JpaOffsetPageDaoTest() {
