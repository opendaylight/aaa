 ...
 */
public class GetDependentQuery<I extends Serializable, T extends Identifiable<? super T, I> & Dependent<Id<O, E>>, E extends Serializable, O extends Identifiable<? super O, E>, C>
        implements Query<T, C> {

    private Id<T, I> id;
    private DependentDao<I, T, ?, ?, E, O, C> dao;

    private GetDependentQuery(Id<T, I> id, DependentDao<I, T, ?, ?, E, O, C> dao) {
        this.id = id;
        this.dao = dao;
    }
     ...
     * @return the query
     */
    public static <E extends Serializable, I extends Serializable, T extends Identifiable<? super T, I> & Dependent<Id<O, E>>, O extends Identifiable<? super O, E>, C> Query<T, C> createQuery(
            Id<T, I> id, DependentDao<I, T, ?, ?, E, O, C> dao) {
        return new GetDependentQuery<I, T, E, O, C>(id, dao);
    }
