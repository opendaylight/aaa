...
/**
 * Dependent Data Access Object that supports paging via {@link OffsetPage}.
 * <p>
 ...
 */
public interface OffsetPageDependentDao<I extends Serializable, T extends Identifiable<? super T, I> & Dependent<Id<O, E>>, F, S, E extends Serializable, O extends Identifiable<? super O, E>, C>
        extends PagedDependentDao<I, T, F, S, OffsetPageRequest, OffsetPage<T>, E, O, C> {
