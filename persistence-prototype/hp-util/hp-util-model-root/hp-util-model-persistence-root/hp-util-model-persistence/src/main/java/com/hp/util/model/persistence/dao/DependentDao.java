 ...
 */
public interface DependentDao<I extends Serializable, T extends Identifiable<? super T, I> & Dependent<Id<O, E>>, F, S, E extends Serializable, O extends Identifiable<? super O, E>, C>
        extends KeyValueDependentDao<I, T, E, O, C> {

    /**
     * Get the objects from the data store that match the given filter.
     * 
