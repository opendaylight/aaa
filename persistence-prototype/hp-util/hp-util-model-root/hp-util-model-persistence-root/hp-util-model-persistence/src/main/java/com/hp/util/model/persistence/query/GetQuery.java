 ...
 */
public class GetQuery<I extends Serializable, T extends Identifiable<? super T, I>, C> implements Query<T, C> {

    private Id<T, I> id;
    private BaseDao<I, T, C> dao;

    private GetQuery(Id<T, I> id, BaseDao<I, T, C> dao) {
        this.id = id;
        this.dao = dao;
    }
     ...
     * @return the query
     */
    public static <I extends Serializable, T extends Identifiable<? super T, I>, C> Query<T, C> createQuery(
