 ...
 */
public final class LongColumn<C extends Serializable & Comparable<C>> extends Column<C, Long> {
     ...
     */
    public LongColumn(ColumnName<C, Long> name) {
        super(name);
    }
     ...
     */
    public LongColumn(ColumnName<C, Long> name, Long value) {
        super(name, value);
    }
