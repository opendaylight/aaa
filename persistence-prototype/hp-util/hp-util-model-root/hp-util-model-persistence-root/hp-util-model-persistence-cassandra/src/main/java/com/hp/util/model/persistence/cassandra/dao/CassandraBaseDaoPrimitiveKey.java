...
/**
 * {@link CassandraBaseDao} where the key is a primitive or basic type understood by Cassandra:
 ...
 */
public abstract class CassandraBaseDaoPrimitiveKey<I extends Serializable, T extends Identifiable<? super T, I>, N>
        extends CassandraBaseDao<I, I, T, N> {
     ...
     */
    protected CassandraBaseDaoPrimitiveKey(MainColumnFamilyPrimitiveKey<I, T> mainColumnFamily) {
