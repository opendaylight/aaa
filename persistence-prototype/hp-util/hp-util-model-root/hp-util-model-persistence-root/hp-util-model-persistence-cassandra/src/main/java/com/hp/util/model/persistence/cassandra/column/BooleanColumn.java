 ...
 */
public final class BooleanColumn<C extends Serializable & Comparable<C>> extends Column<C, Boolean> {
     ...
     */
    public BooleanColumn(ColumnName<C, Boolean> name) {
        super(name);
    }
     ...
     */
    public BooleanColumn(ColumnName<C, Boolean> name, Boolean value) {
        super(name, value);
    }
