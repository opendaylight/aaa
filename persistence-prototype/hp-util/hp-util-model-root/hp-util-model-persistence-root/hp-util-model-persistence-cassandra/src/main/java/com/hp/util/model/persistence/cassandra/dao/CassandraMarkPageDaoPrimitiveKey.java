...
/**
 * {@link CassandraMarkPageDao} where the key is a primitive or basic type understood by Cassandra:
 ...
 */
public abstract class CassandraMarkPageDaoPrimitiveKey<I extends Serializable, T extends Identifiable<? super T, I>, F, S, N>
        extends CassandraMarkPageDao<I, I, T, F, S, N> {
     ...
     */
    protected CassandraMarkPageDaoPrimitiveKey(MainColumnFamilyPrimitiveKey<I, T> mainColumnFamily) {
