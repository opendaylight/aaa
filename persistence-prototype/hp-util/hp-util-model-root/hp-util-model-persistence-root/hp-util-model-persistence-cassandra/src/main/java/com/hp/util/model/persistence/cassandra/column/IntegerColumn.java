 ...
 */
public final class IntegerColumn<C extends Serializable & Comparable<C>> extends Column<C, Integer> {

    /**
     * Creates an int column with no value.
     * 
     * @param name column's name
     */
    public IntegerColumn(ColumnName<C, Integer> name) {
        super(name);
    }
     ...
     */
    public IntegerColumn(ColumnName<C, Integer> name, Integer value) {
        super(name, value);
    }
