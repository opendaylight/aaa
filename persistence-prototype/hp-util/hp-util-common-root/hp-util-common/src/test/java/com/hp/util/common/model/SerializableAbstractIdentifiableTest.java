...
public class SerializableAbstractIdentifiableTest {
    ...
    public void testSerialization() {
        SemanticCompatibilityVerifier<ConcreteIdentifiable> semanticVerifier = new SemanticCompatibilityVerifier<ConcreteIdentifiable>() {
            @Override
            public void assertSemanticCompatibility(ConcreteIdentifiable original, ConcreteIdentifiable replica) {
                Assert.assertEquals(original.getId(), replica.getId());
            }
        };

        Id<ConcreteIdentifiable, Long> id = Id.valueOf(Long.valueOf(1));
        SerializabilityTester.testSerialization(new ConcreteIdentifiable(id), semanticVerifier);
        SerializabilityTester.testSerialization(new ConcreteIdentifiable(), semanticVerifier);
    }
    ...
    private static class ConcreteIdentifiable extends SerializableAbstractIdentifiable<ConcreteIdentifiable, Long> {
