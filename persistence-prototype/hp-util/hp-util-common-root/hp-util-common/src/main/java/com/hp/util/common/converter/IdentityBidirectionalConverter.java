...
/**
 * Identity {@link BidirectionalConverter}.
 * <p>
 ...
 */
public final class IdentityBidirectionalConverter<E> implements BidirectionalConverter<E, E> {
    /*
    ...
    private static final IdentityBidirectionalConverter INSTANCE = new IdentityBidirectionalConverter();

    private IdentityBidirectionalConverter() {
    ...
    public static <E> IdentityBidirectionalConverter<E> getInstance() {
        return INSTANCE;
    }
    ...
    @Override
    public E restore(E target) throws IllegalArgumentException {
        return target;
    }
}
