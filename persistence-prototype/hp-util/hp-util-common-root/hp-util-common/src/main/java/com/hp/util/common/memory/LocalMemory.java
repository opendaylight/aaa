...
/**
 * Local memory. This class makes sure all threads access the same data and not a local copy.
 * 
...
public class LocalMemory<D> implements Memory<D> {
    ...
    public synchronized D read() {
        // Synchronized method to ensure all threads access the same data and not a local copy.
        return this.value;
    }
