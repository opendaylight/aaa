 ...
 */
public final class ArgumentMatcherSubscriber {

    private ArgumentMatcherSubscriber() {
     ...
     * <p>
     * See {@link ArgumentMatcherSubscriber#match(ArgumentMatcher)} for the preferred way.
     * 
     * @param <T> type of the argument
     * @param matcher matcher to register
     * @return <code>null</code>
     * @see ArgumentMatcherSubscriber#match(ArgumentMatcher)
     */
