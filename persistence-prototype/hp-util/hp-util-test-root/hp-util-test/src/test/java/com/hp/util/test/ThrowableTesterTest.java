...
public class ThrowableTesterTest {
    ...
    public void testAssertAnyThrowableTypeFail() {
        try {
            ThrowableTester.assertAnyThrowableType(RuntimeException.class, new Exception());
            // Note: Asser.fail() cannot be used because is throws an AssertionError.
            throw new RuntimeException("Expected failure");
        }
        catch (AssertionError e) {
            String expected = getMessage(RuntimeException.class);
            String actual = getMessage(Exception.class);
            String expectedMessage = "Invalid throwable, expected any <" + expected + "> but was <" + actual + ">";
    ...
    public void testAssertThrowableTypeFail() {
        try {
            ThrowableTester.assertThrowableType(ExceptionTest.class, new Exception());
            throw new RuntimeException("Expected failure");
        }
        catch (AssertionError e) {
            String expected = getMessage(ExceptionTest.class);
            String actual = getMessage(Exception.class);
            String expectedMessage = "Invalid throwable, expected:<class " + expected + "> but was:<class " + actual
                    + ">";
            Assert.assertEquals(expectedMessage, e.getMessage());
        }
    }
    ...
    public void testThrowsAnyWithValidator() throws Throwable {
        ...
        Validator<RuntimeException> validator = EasyMock.createMock(Validator.class);
        ...
        ThrowableTester.testThrowsAny(RuntimeException.class, instructionMock, validator);
    ...
    public void testThrowsAnyFailNoThrowable() throws Throwable {
        ...
        try {
            ...
            String expected = getMessage(RuntimeException.class);
            String expectedMessage = "Expected any <" + expected + "> but nothing was thrown";
            Assert.assertEquals(expectedMessage, e.getMessage());
        }
    ...
    public void testThrowsWithValidator() throws Throwable {
        ...
        Instruction instructionMock = EasyMock.createMock(Instruction.class);
        @SuppressWarnings("unchecked")
        Validator<ExceptionTest> validator = EasyMock.createMock(Validator.class);
        ...
        ThrowableTester.testThrows(ExceptionTest.class, instructionMock, validator);
    ...
    public void testThrowsFailNoThrowable() throws Throwable {
        ...
        try {
            ...
            String expected = getMessage(RuntimeException.class);
            String expectedMessage = "Expected <" + expected + "> but nothing was thrown";
            Assert.assertEquals(expectedMessage, e.getMessage());
        }
