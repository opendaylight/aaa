...
public class NetworkDeviceDaoTest
        extends
        JpaOffsetPageDaoTest<SerialNumber, NetworkDevice, NetworkDeviceFilter, NetworkDeviceSortKey, NetworkDeviceDao> {

    @Override
    protected NetworkDeviceDao createDaoInstance() {
        return new NetworkDeviceDao();
    }
