...
public interface ServletDetails {
     ...
     */
    final class Builder {
        private record DefaultServletDetails(Servlet servlet, String name, ImmutableList<String> urlPatterns,
                ImmutableMap<String, String> initParams, boolean asyncSupported) implements ServletDetails {
            DefaultServletDetails {
         ...
         *
         * @param element A urlPatterns element
         * @return {@code this} builder for use in a chained invocation
        ...
        public @NonNull ServletDetails build() {
            ...
            return new DefaultServletDetails(servlet, name != null ? name : servlet.getClass().getName(),
