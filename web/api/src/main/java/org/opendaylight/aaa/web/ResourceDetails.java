...
public interface ResourceDetails {
    /**
     * Get resource base name. The base name of the resources that will be registered, typically a directory
     * in the bundle/jar where "/" is used to denote the root.
     *
    ...
    /**
     * Get resource mapped alias. The name in the URI namespace to which the resources are mapped. This
