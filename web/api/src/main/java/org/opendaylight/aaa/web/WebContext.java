...
public interface WebContext {
    ...
    final class Builder {
        private record DefaultWebContext(String contextPath, ImmutableList<ServletDetails> servlets,
        ...
        public @NonNull WebContext build() {
            ...
            return new DefaultWebContext(contextPath, servlets.build(), filters.build(), listeners.build(),
