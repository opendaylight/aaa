...
public interface FilterDetails {
     ...
     */
    final class Builder {
        private record DefaultFilterDetails(Filter filter, String name, ImmutableList<String> urlPatterns,
                ImmutableMap<String, String> initParams, boolean asyncSupported) implements FilterDetails {
            DefaultFilterDetails {
        ...
        public @NonNull FilterDetails build() {
            ...
            return new DefaultFilterDetails(filter, name != null ? name : filter.getClass().getName(),
