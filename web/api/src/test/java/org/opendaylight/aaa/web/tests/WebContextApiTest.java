...
public class WebContextApiTest {
    ...
    public void testMinimalBuilder() {
        assertThat(WebContext.builder().contextPath("test").build().supportSessions()).isTrue();
        assertThat(WebContext.builder().contextPath("test").supportSessions(false).build().contextPath())
                .isEqualTo("test");
    }
