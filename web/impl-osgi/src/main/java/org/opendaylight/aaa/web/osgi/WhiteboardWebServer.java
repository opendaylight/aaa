...
public final class WhiteboardWebServer implements WebServer {
    ...
    private final ServiceReference<HttpServiceRuntime> serviceRuntime;

    @Activate
    public WhiteboardWebServer(final ComponentContext componentContext,
            @Reference final ServiceReference<HttpServiceRuntime> serviceRuntime) {
        bundle = componentContext.getUsingBundle();
        this.serviceRuntime = requireNonNull(serviceRuntime);
