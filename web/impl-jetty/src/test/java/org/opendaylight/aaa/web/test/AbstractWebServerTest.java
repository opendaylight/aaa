...
public abstract class AbstractWebServerTest {
    ...
    public void testAddCommonGzipHandler() throws ServletException, IOException {
        ...
        CommonGzipHandler commonGzipHandler = new CommonGzipHandlerBuilder().addIncludedMimeTypes("text/html",
            "text/plain", "application/xml", "application/yang.data+xml", "xml", "application/json",
            "application/yang.data+json").addIncludedPath("/*").build();
    ...
    public void testAddCommonGzipHandlerNotSetMimeTypes() throws ServletException, IOException {
        ...
        CommonGzipHandler commonGzipHandler = new CommonGzipHandlerBuilder().addIncludedPath("/*").build();
