...
public class JettyWebServer implements WebServer {
    ...
    public synchronized WebContextRegistration registerWebContext(final WebContext webContext) throws ServletException {
        ...
        if (webContext.commonGzipHandler().isPresent()) {
            ...
            gzipHandler.setIncludedMimeTypes(commonGzipHandler.includedMimeTypes().toArray(new String[0]));
            gzipHandler.setIncludedPaths(commonGzipHandler.includedPaths().toArray(new String[0]));
