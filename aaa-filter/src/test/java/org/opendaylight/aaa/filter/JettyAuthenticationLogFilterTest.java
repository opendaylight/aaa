...
class JettyAuthenticationLogFilterTest {
    private static final JettyAuthenticationLogFilter CUSTOM_FILTER_ADAPTER = new JettyAuthenticationLogFilter();
    ...
    public void testSettingAuthenticationIntoJettyRequest() throws Exception {
        ...
        CUSTOM_FILTER_ADAPTER.doFilter(mockServletRequest, mockResponse, mockFilterChain);
        ...
        assertEquals(1, CUSTOM_FILTER_ADAPTER.sessionMap().size());
    }
}
