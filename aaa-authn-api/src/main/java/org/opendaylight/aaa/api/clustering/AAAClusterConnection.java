...
public class AAAClusterConnection extends Thread{
    ...
    public void writeObject(Object o){
        final byte data[] = AAAObjectEncoder.encodeOperation(AAAClusterNode.OPERATION_WRITE,o);
    ...
    public void updateObject(Object o){
        final byte data[] = AAAObjectEncoder.encodeOperation(AAAClusterNode.OPERATION_UPDATE,o);
        synchronized(this.socket){
            try {
                this.socket.getOutputStream().write(data.length);
                this.socket.getOutputStream().write(data);
    ...
    public void deleteObject(Object o){
        final byte data[] = AAAObjectEncoder.encodeOperation(AAAClusterNode.OPERATION_DELETE,o);
        synchronized(this.socket){
            try {
                this.socket.getOutputStream().write(data.length);
                this.socket.getOutputStream().write(data);
