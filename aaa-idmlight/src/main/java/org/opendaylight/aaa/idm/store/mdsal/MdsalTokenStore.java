...
public class MdsalTokenStore implements AutoCloseable, TokenStore {
    ...
    public MdsalTokenStore(final DataBroker dataBroker, final AAAEncryptionService dataEncrypter) {
    ...
    public void put(String token, Authentication auth) {
        ...
        UserTokens userTokens = MdsalStoreUtil.createUserTokens(token, timeToLive.longValue());
