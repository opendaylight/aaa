 ...
 *
 * <b>Create A Domain</b>
 * <code>curl -u admin:admin -X POST -H "Content-Type: application/json" --data-binary \@domain.json http://{HOST}:{PORT}/auth/v1/domains</code>
 ...
 *
 * <b>Update A Domain</b>
 * <code>curl -u admin:admin -X PUT -H "Content-Type: application/json" --data-binary \@domain.json http://{HOST}:{PORT}/auth/v1/domains</code>
 * Example domain.json <code>{
