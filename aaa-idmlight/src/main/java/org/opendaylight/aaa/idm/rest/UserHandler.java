 ...
 *
 * <b>Create A User</b>
 * <code>curl -u admin:admin -X POST -H "Content-type: application/json" --data-binary {@literal @}user.json http://{HOST}:{PORT}/auth/v1/users
 ...
 *
 * <b>Update A User</b>
 * <code>curl -u admin:admin -X PUT -H "Content-type: application/json" --data-binary {@literal @}user.json http://{HOST}:{PORT}/auth/v1/users/{id}
 * An example of user.json file is:
 * <code>{
 *   "name": "admin2",
 *   "password", "admin2",
