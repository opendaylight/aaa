...
public abstract class IDMObject {
    private static Map<Class<?>,ConvertionMethods> typesMethods = new HashMap<Class<?>,ConvertionMethods>();
    public static Object fromMDSALObject(Object mdsalObject,Class<?> type) throws Exception{
    ...
    public static Object toMDSALObject(Object object,Class<?> mdSalBuilderType) throws Exception{
