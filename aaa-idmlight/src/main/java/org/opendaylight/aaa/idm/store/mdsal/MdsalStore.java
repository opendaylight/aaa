...
public class MdsalStore implements IIDMStore {
    ...
    public MdsalStore(IdManagementMdsaLStore mdsalStore) {
    ...
    public Domains getDomains() throws IDMStoreException {
        ...
        List<org.opendaylight.yang.gen.v1.urn.aaa.idm.store.mdsal.rev170517.authentication.Domain> mdSalDomains =
                mdsalStore.getAllDomains();
        for (org.opendaylight.yang.gen.v1.urn.aaa.idm.store.mdsal.rev170517.authentication.Domain d : mdSalDomains) {
    ...
    public Roles getRoles() throws IDMStoreException {
        ...
        List<org.opendaylight.yang.gen.v1.urn.aaa.idm.store.mdsal.rev170517.authentication.Role> mdSalRoles = mdsalStore
                .getAllRoles();
        for (org.opendaylight.yang.gen.v1.urn.aaa.idm.store.mdsal.rev170517.authentication.Role r : mdSalRoles) {
    ...
    public Users getUsers() throws IDMStoreException {
        ...
        List<org.opendaylight.yang.gen.v1.urn.aaa.idm.store.mdsal.rev170517.authentication.User> mdSalUsers = mdsalStore
                .getAllUsers();
        for (org.opendaylight.yang.gen.v1.urn.aaa.idm.store.mdsal.rev170517.authentication.User u : mdSalUsers) {
    ...
    public Grants getGrants(String domainid, String userid) throws IDMStoreException {
        ...
        List<org.opendaylight.yang.gen.v1.urn.aaa.idm.store.mdsal.rev170517.authentication.Grant> mdSalGrants =
                mdsalStore.getAllGrants();
        String currentGrantUserId;
        String currentGrantDomainId;
        for (org.opendaylight.yang.gen.v1.urn.aaa.idm.store.mdsal.rev170517.authentication.Grant g : mdSalGrants) {
