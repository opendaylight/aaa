...
public class MdsalStore implements IIDMStore {
    ...
    public Domains getDomains() throws IDMStoreException {
        ...
        List<org.opendaylight.yang.gen.v1.urn.aaa.idm.store.mdsal.rev170517.authentication.Domain> mdSalDomains = mdsalStore
                .getAllDomains();
    ...
    public Grants getGrants(String domainid, String userid) throws IDMStoreException {
        ...
        List<org.opendaylight.yang.gen.v1.urn.aaa.idm.store.mdsal.rev170517.authentication.Grant> mdSalGrants = mdsalStore
                .getAllGrants();
