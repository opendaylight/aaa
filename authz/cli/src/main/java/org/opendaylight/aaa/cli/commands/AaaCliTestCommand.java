...
public class AaaCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(AaaCliTestCommand.class);
    protected final AaaCliCommands service;

    public AaaCliTestCommand(final AaaCliCommands service) {
