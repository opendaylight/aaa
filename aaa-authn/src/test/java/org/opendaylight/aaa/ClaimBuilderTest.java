...
public class ClaimBuilderTest {
    ...
    public void testBuildWithNullUser() {
        ClaimBuilder c1 = new ClaimBuilder().setUserId(null).setUserId("1234").addRole("foo");
        c1.build();
    }

    @Test(expected=IllegalStateException.class)
    public void testBuildWithEmptyUser() {
        ClaimBuilder c1 = new ClaimBuilder().setUserId("  ").setUserId("1234").addRole("foo");
        c1.build();
    }
    ...
    public void testBuildWithNullUserId() {
        ClaimBuilder c1 = new ClaimBuilder().setUserId("john").setUserId(null).addRole("foo");
        c1.build();
    }

    @Test(expected=IllegalStateException.class)
    public void testBuildWithEmptyUserId() {
        ClaimBuilder c1 = new ClaimBuilder().setUserId("john").setUserId("  ").addRole("foo");
        c1.build();
    }
    ...
    public void testBuildWithNullRole() {
        ClaimBuilder c1 = new ClaimBuilder().setUserId("john").setUserId("1234").addRole(null);
        c1.build();
    }

    @Test(expected=IllegalStateException.class)
    public void testBuildWithEmptyRole() {
        ClaimBuilder c1 = new ClaimBuilder().setUserId("john").setUserId("1234").addRole("  ");
        c1.build();
    }
