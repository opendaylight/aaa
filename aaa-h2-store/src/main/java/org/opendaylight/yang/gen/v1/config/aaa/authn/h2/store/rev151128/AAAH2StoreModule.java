...
public class AAAH2StoreModule extends org.opendaylight.yang.gen.v1.config.aaa.authn.h2.store.rev151128.AbstractAAAH2StoreModule {
    ...
    public static void initTable(final Connection connection, final String tableName, final String sqlCreationStatement) {
    ...
    private static boolean tableExists(final ResultSet resultSet, final String tableName) {
    ...
    private static boolean createTable(final Connection connection, final String tableName, final String sqlCreationStatement) {
