...
public class H2StoreTest {
    ...
    public void before() throws StoreException, SQLException {
        UserStore us = new UserStore(new IdmLightConnectionFactory());
        us.dbClean();
        DomainStore ds = new DomainStore(new IdmLightConnectionFactory());
        ds.dbClean();
        RoleStore rs = new RoleStore(new IdmLightConnectionFactory());
        rs.dbClean();
        GrantStore gs = new GrantStore(new IdmLightConnectionFactory());
        gs.dbClean();
