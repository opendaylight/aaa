...
public class H2StoreTest {
    ...
    public void before() throws StoreException, SQLException {
        UserStore us = new UserStore(new IdmLightSimpleConnectionProvider(new IdmLightConfig()));
        us.dbClean();
        DomainStore ds = new DomainStore(new IdmLightSimpleConnectionProvider(new IdmLightConfig()));
        ds.dbClean();
        RoleStore rs = new RoleStore(new IdmLightSimpleConnectionProvider(new IdmLightConfig()));
        rs.dbClean();
        GrantStore gs = new GrantStore(new IdmLightSimpleConnectionProvider(new IdmLightConfig()));
        gs.dbClean();
