...
public class AAAEncryptServiceImplTest {
    ...
    public void testDecryptWithIllegalArgumentException() {
        final var ex = assertThrows(EncryptionServiceException.class, () -> impl.decrypt("admin"));
        assertEquals("", ex.getMessage());
    }

    @Test
    public void testDecryptWithIllegalBlockSizeException() {
        final var ex = assertThrows(EncryptionServiceException.class, () -> impl.decrypt("adminadmin"));
        assertEquals("", ex.getMessage());
    }

    @Test
    public void testDecryptWithBadPaddingException() {
        final var ex = assertThrows(EncryptionServiceException.class, () -> impl.decrypt("ValidOmse64EncodedDatQ=="));
        assertEquals("", ex.getMessage());
    }
}
