...
public final class AAAEncryptionServiceImpl implements AAAEncryptionService {
    ...
    private void initEncryptCipher() {
        try {
            baseEncryptCipher.init(Cipher.ENCRYPT_MODE, key, ivSpec);
            encryptCipher = baseEncryptCipher;
        } catch (GeneralSecurityException e) {
    ...
    private void initDecryptCipher() {
        try {
            baseDecryptCipher.init(Cipher.DECRYPT_MODE, key, ivSpec);
            decryptCipher = baseDecryptCipher;
        } catch (GeneralSecurityException e) {
