...
public abstract class AbstractMain {
    ...
    protected abstract void setDbDirectory(File dbDirectory) throws IOException;
    ...
    protected abstract int addNewUsers(List<String> userNames, List<String> passwords) throws IDMStoreException;
