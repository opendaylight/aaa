...
/**
 * * This class is a codec to convert between MDSAL objects and IDM model
 * objects. It is doing so via reflection when it assumes that the MDSAL Object
 * and the IDM model object has the same method names.
 *
...
public abstract class IDMObject2MDSAL {
    ...
    // Convert Domain
    @SuppressWarnings("checkstyle:IllegalCatch")
    public static org.opendaylight.yang.gen.v1.urn.aaa.yang
            .authn.claims.rev141029.authentication.Domain toMDSALDomain(
            Domain domain) {
        try {
            return (org.opendaylight.yang.gen.v1.urn.aaa
                        .yang.authn.claims.rev141029.authentication.Domain) toMDSALObject(
    ...
    @SuppressWarnings("checkstyle:IllegalCatch")
    public static org.opendaylight.yang.gen.v1.urn.aaa.yang
            .authn.claims.rev141029.authentication.Role toMDSALRole(Role role) {
        try {
    ...
    public static org.opendaylight.yang.gen.v1.urn.aaa.yang.authn.claims.rev141029.authentication.Grant toMDSALGrant(
        ...
        try {
            return (org.opendaylight.yang.gen.v1.urn.aaa
                    .yang.authn.claims.rev141029.authentication.Grant) toMDSALObject(
