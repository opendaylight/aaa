...
public class AuthNStoreUtil {
    ...
    public static Authentication convertClaimToAuthentication(Claims claim, Long expiration) {
        AuthenticationBuilder authBuilder = new AuthenticationBuilder();
        authBuilder.addRoles(new HashSet<String>(claim.getRoles()));
        authBuilder.setClientId(claim.getClientId());
        authBuilder.setDomain(claim.getDomain());
        authBuilder.setUser(claim.getUser());
        authBuilder.setUserId(claim.getUserId());
