...
public class IDMMDSALStore {
    ...
    public Domain writeDomain(Domain domain) {
        ...
        b.setKey(new DomainKey(domain.getName()));
        ...
        wrt.put(LogicalDatastoreType.CONFIGURATION, ID, domain);
        wrt.submit();
        return domain;
    }
    ...
    public Domain readDomain(String domainid){
        ...
        try {
            ...
            LOGGER.error("Failed to read domain from data store",e);
            return null;
        }
    }
    ...
    public Role writeRole(Role role) {
        ...
        b.setKey(new RoleKey(role.getRoleid()));
        ...
        WriteTransaction wrt = dataBroker.newWriteOnlyTransaction();
        wrt.put(LogicalDatastoreType.CONFIGURATION, ID, role);
        wrt.submit();
        return role;
    }
    ...
    public Role readRole(String roleid){
        ...
        try {
            ...
            LOGGER.error("Failed to read role from data store",e);
            return null;
        }
    }
    ...
    public User writeUser(User user) throws IDMStoreException {
        ...
        b.setKey(new UserKey(user.getUserid()));
        ...
        WriteTransaction wrt = dataBroker.newWriteOnlyTransaction();
        wrt.put(LogicalDatastoreType.CONFIGURATION, ID, user);
        wrt.submit();
        return user;
    }
    ...
    public User readUser(String userid){
        ...
        try {
            ...
            LOGGER.error("Failed to read user from data store",e);
            return null;
        }
    }
    ...
    public Grant writeGrant(Grant grant) throws IDMStoreException {
        ...
        b.setKey(new GrantKey(grant.getGrantid()));
        grant = b.build();
        ...
        WriteTransaction wrt = dataBroker.newWriteOnlyTransaction();
        wrt.put(LogicalDatastoreType.CONFIGURATION, ID, grant);
        wrt.submit();
        return grant;
    }
    ...
    public Grant readGrant(String grantid){
        ...
        try {
            ...
            LOGGER.error("Failed to read grant from data store",e);
            return null;
        }
    }
