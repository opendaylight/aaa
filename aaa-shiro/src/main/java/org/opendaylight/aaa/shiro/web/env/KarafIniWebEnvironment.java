...
public class KarafIniWebEnvironment extends IniWebEnvironment {
     ...
     */
    private static final String DEFAULT_SHIRO_INI_FILE = "etc" + File.separator + "shiro.ini";

    /**
     * The Shiro-specific prefix used to indicate file based Shiro configuration
     */
    private static final String SHIRO_FILE_PREFIX = "file:" + File.separator;
     ...
     */
    private static Ini createDefaultShiroIni() throws FileNotFoundException {
     ...
     */
    private static Ini createShiroIni(final String path) throws FileNotFoundException {
     ...
     */
    private static String createFileBasedIniPath(final String path) {
