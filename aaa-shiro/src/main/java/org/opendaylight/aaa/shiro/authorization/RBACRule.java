...
public class RBACRule {
     ...
     *
     * @param urlPattern Cannot be null or the empty string.
     * @param roles Must contain at least one role.
     * @throws NullPointerException if <code>urlPattern</code> or <code>roles</code> is null
     * @throws IllegalArgumentException if <code>urlPattern</code> is an empty string or
     ...
     *
     * @param urlPattern Cannot be null or the empty string.
     * @param roles Cannot be null or an emtpy collection.
    ...
    public Collection<String> getRoles() {
        // Returns a copy of the roles collection such that the original set keeps
    ...
    private void setRoles(final Collection<String> roles)
            throws NullPointerException, IllegalArgumentException {
    ...
    /**
     * Generates the string representation of the <code>RBACRule</code> in
     * shiro form.  For example:
     * <code>urlPattern=roles[admin,user]</code>
     */
    @Override
