 ...
 * <code>ServiceProxy.getInstance().setEnabled(true)</code>.  AuthN and AuthZ
 * are disabled by default in order to support workflows such as
 * the feature <code>odl-restconf-noauth</code>.
 *
 ...
 * @link https://github.com/opendaylight/netconf/blob/master/opendaylight/restconf/sal-rest-connector/src/main/resources/WEB-INF/web.xml
...
public class ServiceProxy {
  ...
  public synchronized void setEnabled(final boolean enabled) {
    ...
    final String SERVICE_ENABLED_INFO_MESSAGE =
        "Setting ServiceProxy enabled to " + enabled;
   ...
   *
   * @param filter register an optional Filter for callback if enable state
   * changes
   * @return
   */
