 ...
 * delivering debug information;  to enable these debug statements, please
 * issue the following in the karaf shell:
 *
...
public class AAAFilter extends ShiroFilter {
  ...
  public void init() throws Exception {
    ...
    // bundle loading, this passes an instance of itself along so that if the
