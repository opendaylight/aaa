...
public class ODLJndiLdapRealm extends JndiLdapRealm implements Nameable {
    ...
    private GroupsToRolesMappingStrategy groupsToRolesMappingStrategy = new BestAttemptGroupToRolesMappingStrategy();
            ...
            if (attrs != null) {
                ...
                while (ae.hasMore()) {
                    ...
                    if (attr.getID().equals(ldapAttributeForComparison)) {
                        ...
                        final Map<String, Set<String>> groupsToRoles = this.groupsToRolesMappingStrategy.mapGroupsToRoles(
