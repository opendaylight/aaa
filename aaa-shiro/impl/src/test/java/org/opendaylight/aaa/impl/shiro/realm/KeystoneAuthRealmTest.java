...
public class KeystoneAuthRealmTest {
    ...
    public void setup() throws MalformedURLException, URISyntaxException {
        ...
        when(builder.addQueryParams(any(String.class), any(String.class))).thenReturn(builder);
    ...
    public void doGetAuthenticationInfoAuthorized() throws Exception {
        ...
        List<KeystoneToken.Token.Role> theRoles = Stream.of("admin", "ninja", "death-start-commander")
