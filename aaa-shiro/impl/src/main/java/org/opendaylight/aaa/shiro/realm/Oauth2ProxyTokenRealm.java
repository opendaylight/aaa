...
public final class Oauth2ProxyTokenRealm extends AuthorizingRealm {
    ...
    public boolean supports(final AuthenticationToken token) {
        return token instanceof Oauth2ProxyToken;
    }
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(final AuthenticationToken token)
        ...
        final var userId = proxyToken.user() + "@" + SDN_DOMAIN;
        final var odlPrincipal = ODLPrincipalImpl.createODLPrincipal(proxyToken.user(), SDN_DOMAIN, userId,
    ...
    private static Set<String> parseRoles(final String groups) {
