 ...
 */
public class ODLDefaultLdapRealm extends DefaultLdapRealm {

    private static final Logger LOG = LoggerFactory.getLogger(ODLDefaultLdapRealm.class);
     ...
     */
    public ODLDefaultLdapRealm() {
        LOG.debug("Creating {}", ODLDefaultLdapRealm.class.getName());
    }
     ...
     * @param ldapContext The specific system context provided by <code>aaa-app-config.xml</code>
    ...
    /**
     * Injected from <code>aaa-app-config.xml</code> configuration.
     *
