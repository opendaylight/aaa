...
import static org.opendaylight.aaa.shiro.filters.Oauth2ProxyHeaderFilterConfig.PROXY_HEADER_GROUPS;
import static org.opendaylight.aaa.shiro.filters.Oauth2ProxyHeaderFilterConfig.PROXY_HEADER_USER;
...
final class Oauth2ProxyHeaderParser {
    ...
    static Set<String> parseRolesHeader(final ServletRequest request, final int maxHeaderLength,
            ...
            final Pattern allowedCharactersPatter) {
        final var roles = WebUtils.toHttp(request).getHeaders(PROXY_HEADER_GROUPS);
        return parseRoles(roles, maxHeaderLength, maxRolesPerUser, maxRoleLength, headerPattern,
            allowedCharactersPatter);
    }
     ...
     */
    @VisibleForTesting
    static Set<String> parseRoles(final ServletRequest request, final int maxHeaderLength,
            final int maxRolesPerUser, final int maxRoleLength, final Pattern headerPattern,
            final Pattern allowedCharactersPattern) {
