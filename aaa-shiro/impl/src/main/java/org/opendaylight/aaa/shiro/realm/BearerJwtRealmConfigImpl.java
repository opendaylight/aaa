...
public final class BearerJwtRealmConfigImpl implements BearerJwtRealmConfig {
    ...
    public @interface Configuration {
        ...
        @AttributeDefinition(description = """
            Expected value of the JOSE typ header (e.g. JWT for OAuth 2.0 access tokens per RFC 9068).
        ...
        boolean retry$_$jwks$_$retrival() default false;
    }
    ...
    public BearerJwtRealmConfigImpl(final Configuration configuration) throws Exception {
        ...
        final var jwkSource = JWKSourceBuilder.create(new URI(configuration.jwks$_$uri()).toURL())
            ...
            .retrying(configuration.retry$_$jwks$_$retrival())
            .build();
