...
public final class BearerJwtRealmConfig {
    ...
    public @interface Config {
        @AttributeDefinition(name = "JWKS URI",
            description = """
                ...
                verification (e.g. http(s)://keycloak.local:8080/realms/odl-realm/protocol/openid-connect/certs).
    ...
    public BearerJwtRealmConfig(final Config config) throws Exception {
        ...
        final var claimsVerifier = processor(config);
    ...
    private static DefaultJWTClaimsVerifier<SecurityContext> processor(final Config config) {
