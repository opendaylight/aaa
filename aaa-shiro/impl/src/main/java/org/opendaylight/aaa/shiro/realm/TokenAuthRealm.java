...
public class TokenAuthRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(final AuthenticationToken authenticationToken)
        ...
        final String possiblyQualifiedUser = upt.getUsername();
        final String username = HeaderUtils.extractUsername(possiblyQualifiedUser);
        final String domain = HeaderUtils.extractDomain(possiblyQualifiedUser);
