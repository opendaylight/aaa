...
public class IdmLightApplication extends Application {
    ...
    static class IdmLightServletContainer extends ServletContainer {
        public IdmLightServletContainer(final Application application) {
            super(application);
        }
    }

    public static ServletContainer create() {
        return new IdmLightServletContainer(new IdmLightApplication());
    }
}
