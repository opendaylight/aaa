...
/**
 * REST application used to manipulate the H2 database domains table. The REST endpoint is
 * <code>/auth/v1/domains</code>.
 *
...
public class DomainHandler {
    ...
    public Response createDomain(@Context final UriInfo info, final Domain domain) {
        ...
        return Response.status(CREATED).entity(newDomain).build();
    }
    ...
    public Response createGrant(@Context final UriInfo info, @PathParam("did") final String domainId,
        ...
        if (existingGrant != null) {
            ...
            return Response.status(FORBIDDEN).entity(idmerror).build();
        }
