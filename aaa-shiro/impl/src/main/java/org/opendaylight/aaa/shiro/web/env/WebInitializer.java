...
public class WebInitializer {
    ...
    @Inject
    @Activate
    public WebInitializer(@Reference final WebServer webServer, @Reference final ClaimCache claimCache,
            @Reference final IIDMStore iidMStore, @Reference final WebContextSecurer webContextSecurer,
            @Reference final ServletSupport servletSupport,
            @Reference final CustomFilterAdapterConfiguration customFilterAdapterConfig) throws ServletException {
