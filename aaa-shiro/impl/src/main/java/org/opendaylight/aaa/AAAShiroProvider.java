...
public final class AAAShiroProvider implements TokenProvider {
     ...
     * Constructor.
     */
    public AAAShiroProvider(DataBroker dataBroker, ICertificateManager certificateManager,
                            final PasswordCredentialAuth credentialAuth, ShiroConfiguration shiroConfig,
                            HttpService httpService, String moonEndpointPath, String oathEndpointPath,
                            final DatastoreConfig datastoreConfig, final IIDMStore iidmStore,
                            AuthenticationService authenticationService, PasswordHashService passwordHashService) {
