...
import org.opendaylight.aaa.shiro.filters.Oauth2ProxyHeaderParser;
...
public final class AAAWebEnvironment extends IniWebEnvironment implements AAAShiroWebEnvironment {
     ...
     *
     * <p>Proxy header filter or bearer JWT verification: {@link Oauth2ProxyHeaderFilter} falls back to default limits
     * and {@link BearerJwtRealm} runs in unverified mode.
     *
     ...
     * @param oauth2Parser parser for {@link Oauth2ProxyHeaderFilter}, or {@code null} to use default limits
    ...
    public AAAWebEnvironment(final ShiroIni shiroConfiguration, final DataBroker dataBroker,
        ...
        ClassLoaderUtils.runWithClassLoader(AAAWebEnvironment.class.getClassLoader(), () -> {
            try (var filterLoad = MDSALDynamicAuthorizationFilter.prepareForLoad(dataBroker);
                 ...
                 var oauth2Load = Oauth2ProxyHeaderFilter.prepareForLoad(oauth2Parser);
