 ...
 */
package org.opendaylight.aaa.cli.commands;
...
public class AAAShiroCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(AAAShiroCliTestCommand.class);
    protected final AAAShiroCliCommands service;

    public AAAShiroCliTestCommand(final AAAShiroCliCommands service) {
