...
``role.claim``
    ...
    claim value must be a JSON array of strings. Default: ``roles``.
    Common alternatives: ``groups``, ``realm_access.roles``.
...
**3. Switch URL filters to Bearer authentication**
